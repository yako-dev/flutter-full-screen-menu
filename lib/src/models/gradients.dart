...
final blueGradient = LinearGradient(colors: [Colors.blue, Colors.blue[300]!]);

final deepPurpleGradient = LinearGradient(
  colors: [Colors.deepPurple, Colors.deepPurple[300]!],
);

final redGradient = LinearGradient(colors: [Colors.red, Colors.red[300]!]);
...
final lightGreenGradient = LinearGradient(
  colors: [Colors.lightGreen, Colors.lightGreen[300]!],
);

final blueGreyGradient = LinearGradient(
